...
$(document).ready(function(){
 ...
 $('a[data-moveto]').on('click', function(){
   $("html,body").animate({scrollTop:$($(this).attr("data-moveto")).offset().top});
 });
 ...
 $('.maxbtn').on('click', function(){
   if($("#termart").hasClass("maximized")){
     ...
     $("#termart").animate({"width": prevW, "borderRadius":"5px"},{"queue":false});
     $("#termart .topbar").animate({"borderTopRightRadius":"5px"},{"queue":false});
     $("#termart .topbar").animate({"borderTopLeftRadius":"5px"},{"queue":false});
     $("#termart .prompt").css({"display":"none"});
   }else{
     $("#termart").addClass("maximized");
     prevW = $("#termart").css("width");
     $("#termart").animate({"width": "100%", "borderRadius":"0"},{"queue":false});
     $("#termart .topbar").animate({"borderRadius":"0"},{"queue":false});
     $("#termart .prompt").css({"display":"inline"});
   }
 });
});
